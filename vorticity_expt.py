...
def main():
    ...
    tau = .56 # timescale corresponds to kinematic viscosity
    ...
    F[:,:,3] = 2.6 # we want to flow from left --> right so a non-zero velocity in x direction
    ...
    for iteration in range(0,Nt):
        ...
        if(iteration % plot_every == 0):
            ...
            curl = dfydx - dfydy
            pyplot.imshow(curl,cmap="seismic")
            pyplot.pause(0.1)
            pyplot.cla()
